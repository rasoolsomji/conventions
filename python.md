...
in the `dispatch` method. Because:
...
- This method is called for all HTTP methods and avoids possible security holes
  is permissions are only checked in say the `get` method.
